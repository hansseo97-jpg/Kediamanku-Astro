...
function setJsonLd(data) {
  let script = document.head.querySelector('script[type="application/ld+json"][data-project-schema]');
  if (!script) {
    script = document.createElement("script");
    script.type = "application/ld+json";
    script.dataset.projectSchema = "";
...
function renderProjectTestimonial(project) {
  ...
  const clientImage = project.testimonial_image_url
    ? resolveImagePath(project.testimonial_image_url)
    : "../../kediamanku-monogram.svg";
  testimonialImage.src = clientImage;
...
function setupReveal() {
  const revealItems = [
    ...document.querySelectorAll("[data-reveal], .scope-item, .material-tag"),
  ];
